...
export const faqItems = [
  {
    question: '침향이란 무엇인가요?',
    answer:
      '침향(沈香)은 Aquilaria 나무가 외부 자극(상처, 곰팡이 감염 등)에 의해 수십 년에 걸쳐 생성하는 천연 수지입니다. "물에 가라앉는 향"이라는 뜻으로, 동양에서 3,000년 이상 최고의 향약으로 사용되어 왔습니다.',
  },
  {
  ...
  },
  {
    ...
    answer:
      '네, 현대 의학 연구에서 침향의 수면 개선, 항염, 소화 촉진, 신경 안정, 항산화 효과가 보고되었습니다. 동의보감에서도 침향은 "기를 내리고 위를 따뜻하게 하며 구토를 멈추게 한다"고 기록되어 있습니다.',
  },
  {
    question: '어떤 제품부터 시작하면 좋을까요?',
    answer:
      '처음이시라면 침향 건강차나 침향 스틱으로 시작하시는 것을 추천합니다. 간편하게 섭취할 수 있고, 부담 없는 가격에 침향의 효능을 경험하실 수 있습니다.',
  },
  {
