...
const PROCESS_TAB = {
  ...
  heroVideo: {
    ...
    body: '베트남 5개 성(하띤·동나이·냐짱·푸국·람동) 200ha 부지·400만 그루 규모의 직영 농장에서 최소 25년을 기다려 얻은 수지를, 자체 특허 공정으로 다듬어 한 방울의 오일로 완성합니다.',
  },
  stats: [
  ...
  processGroups: [
    ...
    },
    {
      ...
      description: '',
      image: 'https://xpklzng0qyaecv6i.public.blob.vercel-storage.com/pages/process/process-06-distill.jpg',
      steps: [
