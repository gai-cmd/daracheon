...
<h2>‘밀향수’라는 이름은 어느 문헌에 적혀 있습니까?</h2>
...
<p>교주이물지가 적어 둔 판별 기준도 눈여겨볼 만합니다. 단단할 것, 색이 검을 것, 물에 가라앉을 것 — 세 가지입니다.</p>
<p>오늘날 약전이 정한 성상 규정과 겹치는 대목이 여기에 있습니다. 이름을 처음 적은 문헌과 현대 규격이 같은 성질을 가리키고 있는 셈입니다.</p>
<p>이름 하나가 나무의 산지와 성질을 함께 담고 있습니다.</p>
<h2>‘침수향’과 ‘침향’은 왜 가라앉는다는 뜻일까요?</h2>
...
<p>침수향이라는 이름은 옛 문헌에만 남은 말이 아닙니다. 오늘날 국내 약전의 등록명이 그대로 침수향(沈水香)입니다.</p>
...
<p>표로 옮기면 이름마다 어느 자리에서 온 말인지가 더 또렷해집니다. 왼쪽부터 이름, 그 이름이 나온 자리, 뜻과 특징 순으로 읽으시면 됩니다.</p>
''' + TABLE + '''
...
<p>대라천 참침향도 100% 베트남산입니다. 조엘라이프(주)는 베트남 현지 농장에서 원목을 직접 길러 채취합니다.</p>
<p>옛 지명과 오늘의 원산지 표기가 같은 땅을 가리킨다는 점은 그 자체로 흥미로운 대목입니다. 다만 대라천은 이 사실을 품질의 근거로 삼지 않고, 검사 문서를 따로 제시합니다.</p>
...
<p>이름이 갈리는 지점도 번역에 있습니다. 원문의 한 단어가 여러 언어를 거치면서 서로 다른 향목으로 옮겨진 것입니다.</p>
<p>그래서 경전 속 이름을 근거로 침향의 성질을 설명하지는 않습니다. 이름이 그 자리에 등장한다는 사실과, 그 이름이 무엇을 가리키는지는 별개의 문제이기 때문입니다.</p>
<p>서로 멀리 떨어진 문화권이 각자의 언어로 이 향을 귀하게 불러 왔다는 사실은 남습니다. 이름이 많다는 것은 그만큼 여러 사람에게 여러 방식으로 쓰였다는 흔적입니다.</p>
<h2>같은 ‘아퀼라리아’인데 왜 종소명까지 따져야 하나요?</h2>
...
<p>대조하는 방법은 단순합니다. 제품 라벨의 학명과 원산지 표기를 적어 두고, 판매자가 제시한 검사서의 표기와 글자 그대로 맞춰 보면 됩니다.</p>
<p>둘이 어긋나거나 한쪽에만 적혀 있다면 그 자리에서 물어볼 근거가 생깁니다.</p>
...
<p>이 글에 인용한 논문 역시 대라천이 수행한 연구가 아니라 해당 연구팀의 결과이며, 제품의 효능을 뒷받침하는 자료가 아닙니다.</p>
<p>문헌 이름과 지명은 원문 표기를 그대로 옮겼습니다. 학명 표기도 약전과 국제 분류학이 각각 쓰는 형태를 구분해 적었습니다.</p>
...
<p>이름의 내력은 제품을 고르는 참고 자료이지 품질 보증서가 아닙니다. 대라천은 품질에 관한 판단은 검사 문서로 하시기를 권합니다.</p>
<h2>자주 묻는 질문</h2>
