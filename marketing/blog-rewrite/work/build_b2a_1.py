...
<p>이름 자체가 성질을 설명해 주는 향은 흔치 않습니다. 침향은 그 드문 사례여서, 이름을 따라가는 것만으로도 상당한 정보를 얻습니다.</p>
<p>침수향이라는 이름은 오늘날 서류에도 그대로 남아 있습니다. 국내 약전은 침향을 침수향(沈水香)이라는 이름으로 등록해 두었고, 라틴명은 AQUILARIAE LIGNUM으로 적었습니다.</p>
<p>이름의 계보는 <a href="/blog/agarwood-many-names-milhyangsu">침향을 부르는 이름들</a>에서 문헌별로 따로 정리했습니다.</p>
...
<p>기다리는 시간이 곧 원가입니다. 침향 가격이 다른 향재와 자릿수부터 갈리는 이유가 여기에 있습니다.</p>
<p>수요는 꾸준한데 공급은 시간에 묶여 있습니다. 대라천이 원료를 사 오는 대신 직접 기르는 길을 택한 이유도 여기에 있습니다.</p>
<p>조엘라이프(주)는 베트남 현지 농장에서 침향나무를 직접 길러 관리합니다. 25년이라는 시간을 남의 장부가 아니라 자기 장부에 적어 두는 방식입니다.</p>
<h2>어떤 나무에서만 침향이 나올까요?</h2>
<p>침향이라는 이름이 붙었다고 모두 같은 침향은 아닙니다. 국내 공식 문서는 침향을 <strong>아퀼라리아(Aquilaria)</strong> 속(屬) 나무의 수지에서 나온 것으로 규정합니다.</p>
...
<p>보관 요령은 형태가 달라도 한 줄로 같습니다. 직사광선을 피하고 서늘하고 건조한 곳에 밀폐해 두는 것입니다.</p>
<p>햇빛과 습기는 향을 가장 빨리 무너뜨립니다. 개봉한 뒤 냉장 보관을 권하는 제품도 있으니 라벨 표기를 먼저 읽어 보시기 바랍니다.</p>
...
<p>종교 경전의 침향 대목처럼 해석이 갈리는 자리에서는 이견이 있다는 사실까지 함께 적었습니다. 확인되지 않은 대목을 그럴듯하게 메우는 대신 비워 두는 편을 택했습니다.</p>
...
ART = {
    ...
    "changelog": {
        ...
        "citationsAdded": ["A1", "A2", "A4", "A7", "K1", "K4", "K7"],
        "voiceFixes": 24,
