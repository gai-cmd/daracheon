...
<p>선물을 고르실 때 이 폭이 실제로 도움이 됩니다. 받는 분이 차를 즐기시는지, 향을 좋아하시는지, 매일 무언가를 챙기시는지만 떠올리면 후보가 곧바로 좁혀집니다. 부모님과 어른, 지인, 자기 자신까지 같은 기준으로 고르실 수 있습니다.</p>
...
<p>가격의 높낮이를 품질의 순서로 읽지는 마시기 바랍니다. 팔찌와 스틱이 위쪽에 놓인 까닭은 원목을 통째로 쓰는 형태이기 때문이고, 차와 캡슐이 아래에 놓인 까닭은 소분된 구성이기 때문입니다. 대라천은 같은 25년산 원료를 여러 형태로 나누어 제품을 구성합니다.</p>
...
<p>참고 가격은 침향단이 180,000원, 기보단이 480,000원입니다. 두 제품 모두 낱개로 나뉜 환 형태라 하루치를 챙기기 쉽고, 상자째 건네기에도 무리가 없는 구성입니다.</p>
{{IMG:gift-wrapping}}
...
<p>가격 면에서도 접근이 수월합니다. 침향차·수 세트의 참고 가격은 210,000원으로, 이 글에서 다루는 선물 제품 가운데 낮은 편에 속합니다. 처음 건네는 자리에서 부담을 덜고 싶으실 때 고르시면 됩니다.</p>
<p>구성이 두 가지로 나뉜다는 점도 이 세트의 장점입니다. 차가 입에 맞지 않으시더라도 침향수 100ml로 공간의 향을 즐기실 수 있어, 받는 분의 취향을 모르는 자리에서 실패할 여지가 적습니다.</p>
...
<p>침향스틱의 참고 가격은 1,500,000원이며, 100g 원목 구성입니다. 조금씩 잘라 쓰는 형태라 한 번에 소모되지 않고, 온열판에 올리는 방식과 차로 우려 내는 방식을 함께 쓸 수 있습니다. 향을 오래 곁에 두시려는 분께 맞는 구성입니다.</p>
<p>선향은 사른 뒤 자리를 비우지 않도록, 스틱은 온열판 온도를 확인하도록 대라천은 제품 안내에 함께 적어 두었습니다. 선물하실 때 이 두 줄을 함께 전해 주시기 바랍니다.</p>
...
<p>자기 자신에게 건네는 선물이라면 오래 쓰는 형태가 유리합니다. 침향차 1.5g 티백 10포처럼 여러 날에 나눠 즐기는 구성이나, 하루 1캡슐 표기의 30캡슐 구성이 여기에 해당합니다.</p>
<p>참고 가격으로 보면 침향차·수 세트가 210,000원, 오일 캡슐이 249,000원입니다. 한 번에 큰 결정을 내리기보다 한 구성을 끝까지 써 보신 뒤 다음을 정하시는 편이 낫습니다.</p>
{{IMG:tea-set-gift}}
...
<p>이런 짧은 안내 한 장이 선물의 수명을 늘립니다. 받는 분이 제품을 어떻게 다뤄야 할지 몰라 서랍에 두는 경우가 적지 않기 때문입니다.</p>
<p>주의사항도 빠뜨리지 마시기 바랍니다. 침향단·기보단·선향처럼 12세 미만 어린이와 임산부·수유부에게 권하지 않는 제품이 있으므로, 해당 제품을 고르셨다면 이 내용을 함께 전해 주셔야 합니다.</p>
...
<p>가격 표기는 제품 페이지 기준이며 변동될 수 있습니다. 구매 시점의 가격과 구성은 <a href="/products">제품 페이지</a>에서 다시 확인하시기 바랍니다.</p>
