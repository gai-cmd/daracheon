...
A('<p class="lead"><strong>결론부터.</strong> 침향·백단향·사향은 이름 끝만 같을 뿐 나오는 곳이 서로 다릅니다. 침향은 침향나무가 낸 수지가 밴 나무이고, 백단향은 백단나무이며, 사향은 동물에서 얻습니다. 조엘라이프(주)(브랜드 대라천)는 이 셋을 우열로 줄 세우지 않습니다. 성분도 쓰임도 다른 별개의 향재이므로, 이 글은 어느 쪽이 낫다가 아니라 무엇이 어떻게 다른지, 그리고 침향의 경우 무엇으로 진위를 확인하는지만 정리합니다. 향의 우열을 매기는 자리가 아니라, 원재료를 구분하는 자리로 읽어 주시면 됩니다.</p>')
...
A('<p>그럼에도 셋이 자주 뒤섞이는 데에는 이유가 있습니다. 이름이 모두 향으로 끝나 소리부터 비슷하고, 옛 기록에서 귀한 향으로 나란히 언급된 자리가 많았습니다. 무엇보다 직접 맡아 본 경험이 없으면 이름만으로는 갈라내기 어렵습니다. 원재료를 먼저 잡아 두면 이 세 겹의 혼동이 한 번에 풀립니다.</p>')
...
A('<p>다만 물에 가라앉는지 보는 실험 하나로 진위가 갈리지는 않습니다. 밀도를 높이는 방법은 수지 침착 말고도 있기 때문입니다. 대라천이 물 실험과 서류를 늘 함께 두는 이유이며, 이 대목은 따로 정리해 두었습니다(<a href="/blog/proof-in-water-cup-and-papers">물컵 실험과 서류</a>).</p>')
...
A('<p>대라천이 침향을 판매하는 당사자라는 점도 고려했습니다. 파는 쪽이 자기 재료를 다른 재료보다 낫다고 적으면, 그 문장은 비교가 아니라 광고가 됩니다. 그래서 이 글의 기준은 어느 향이 우수한가가 아니라, 대라천이 무엇을 확인했고 무엇은 확인하지 않았는가입니다.</p>')
...
A('<p>표에 넣지 않은 항목도 밝혀 둡니다. 가격, 희소성, 등급은 재료마다 시장과 기준이 달라 한 표에 나란히 놓으면 비교가 아니라 서열처럼 읽힙니다. 대라천은 그 칸을 비워 두었습니다.</p>')
A(FIGURE_IMG)
...
A('<p>성분 이름이 곧 효능은 아닙니다. 위 논문들이 다룬 범위는 어떤 물질이 들어 있고 그 물질이 나무 안에서 어떻게 만들어지는지, 그리고 지금까지 어떤 활성 연구가 있었는지까지입니다. 사람에게 어떤 효과가 있다고 확정한 자료가 아닙니다.</p>')
...
A('<p>산지를 확인하는 실익은 다른 데 있습니다. 어느 밭의 어느 나무에서 왔는지가 잡혀야 품종과 수령, 수지 유도 이력이 함께 따라옵니다. 산지는 품질의 보증서가 아니라 이력을 따라가는 출발점입니다(<a href="/blog/vietnam-5-farms-200ha-4million-trees">베트남 직영 농장 현황</a>).</p>')
A('<p>그래서 대라천은 산지를 자랑 문구가 아니라 확인 항목으로 씁니다. 원산지증명이 가리키는 나라와 농장, 그 농장에서 관리한 품종이 서로 어긋나지 않는지를 맞춰 보는 절차입니다.</p>')
...
A('<p>서류는 각각 다른 질문에 답합니다. 원산지증명은 어디서 왔는지를, DNA 검사는 어떤 종인지를, CITES 인증서는 국제거래 절차를 밟았는지를 확인해 줍니다. 셋 중 하나만으로는 빈칸이 남습니다.</p>')
A(SVG)
...
A('<p>검사 결과는 원료가 바뀌면 다시 받아야 하는 자료입니다. 한 번 받은 성적서를 오래 붙여 두는 방식으로는 지금 손에 든 원목을 설명하지 못합니다. 대라천이 검사번호와 시험일을 함께 적는 것도 그 때문입니다.</p>')
...
A('<p>종교 문헌에도 등장합니다. 대라천 자료는 침향이 성경과 불경에 나오는 향으로 소개되며, 성경 속 침향(aloes)을 오늘날의 침향으로 보는 전통적 해석과 백단향 등 다른 향으로 보는 해석이 갈린다는 점을 함께 밝힙니다.</p>')
...
# H2 9
A('<p>기록의 성격도 갈라 두는 편이 좋습니다. 신분에 따라 사용을 제한했다는 기록은 당시 침향이 얼마나 희소했는지를 보여 주고, 의서에 이름이 올랐다는 기록은 당대 사람들이 이 재료를 어떻게 분류했는지를 보여 줍니다. 어느 쪽도 오늘의 효능 근거로 넘어가지 않습니다.</p>')
...
A('<p>이 목록은 대라천이 직접 의뢰하고 결과지를 받은 항목만 담았습니다.</p>')
...
A('<p>표기 하나하나에도 같은 기준을 둡니다. 100% 베트남산, 유전자형 100% 일치, 중금속 8종 불검출은 시험 결과와 원료 관리 기록에서 바로 확인되는 사실 진술입니다. 반면 향이 더 좋다거나 몸에 낫다는 식의 문장은 확인 가능한 근거가 없어 쓰지 않습니다.</p>')
...
# Sources
A('<h3>Q. 세 향을 함께 쓰는 경우도 있나요?</h3>')
A('<p>A. 대라천은 참침향 원료만 다루므로 백단향·사향의 배합에 대해서는 확인한 자료가 없어 답하지 않습니다. 대라천 제품에 들어가는 원료는 <em>Aquilaria Agallocha Roxburgh</em> 원목에서 얻은 침향입니다.</p>')
A('<h2>근거·출처</h2>')
