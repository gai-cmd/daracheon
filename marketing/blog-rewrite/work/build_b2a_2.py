...
<p>한 가지만 더 짚겠습니다. 침향나무와 침향은 같은 말이 아닙니다. 나무 전체가 아니라 수지가 스며든 부위만 침향으로 쓰입니다.</p>
<p>이름이 성질을 그대로 설명해 주는 향은 흔치 않습니다. 침향은 그 드문 사례입니다.</p>
...
''' + FIGURE + '''
<p>Wang 연구팀은 2021년 <em>Molecules</em> 26권 7708번 논문에서 아퀼라리아 속의 분포와 등급 체계, 수지 유도 방법을 함께 정리했습니다(<a href="https://doi.org/10.3390/molecules26247708" target="_blank" rel="noopener">DOI</a>).</p>
<p>자연에서 우연히 생긴 상처를 기다리는 방식과, 농장에서 상처를 내어 수지를 유도하는 방식이 함께 쓰입니다. 어느 쪽이든 숙성에 드는 시간은 줄지 않습니다.</p>
<p>같은 나무 안에서도 진이 몰린 자리만 검고 무겁게 굳습니다. 진이 닿지 않은 부분은 여느 목재와 다르지 않습니다.</p>
<p>그래서 한 그루에서 나오는 침향의 양은 나무 크기에 비하면 아주 적습니다. 나무를 오래 길러도 쓸 수 있는 부위는 한정돼 있습니다.</p>
<p>{{IMG:farm-rows}}</p>
...
<p>여기에 국제 규제까지 얹힙니다. 침향은 <a href="https://cites.org" target="_blank" rel="noopener">CITES</a>라는 국제 협약이 보호하는 자원이라 함부로 캐서 팔 수 없고, 합법 절차를 밟아야 국경을 넘습니다.</p>
<p>아퀼라리아속은 CITES 부속서 II에 국제 거래 보호종으로 올라 있습니다. 서류 없이 국경을 넘긴 원목은 정식 유통 경로에 오르지 못합니다.</p>
...
<p>수요는 꾸준한데 공급은 시간에 묶여 있습니다. 이 격차가 침향 값을 다른 향재와 자릿수부터 갈라놓습니다.</p>
<p>조엘라이프(주)가 원목을 사들이는 대신 베트남 현지에서 직접 기르는 길을 택한 배경도 같은 자리에 있습니다. 25년이라는 시간을 남의 장부가 아니라 자기 장부에 적어 두는 방식입니다.</p>
...
<p>그래서 아퀼라리아까지만 적힌 표기는 아직 절반짜리입니다. 뒤에 붙는 종소명까지 확인해야 어떤 침향인지 또렷해집니다.</p>
<p>학명은 나라와 언어가 달라도 같은 나무를 가리키도록 만든 공식 이름입니다. 그래서 표기 하나가 곧 대조의 기준이 됩니다.</p>
...
<p>대라천 참침향도 <strong>100% 베트남산</strong>입니다. 조엘라이프(주)는 베트남 현지 농장에서 원목을 직접 길러 채취하고, 원산지를 서류로 함께 밝힙니다.</p>
<p>조선의 문헌 기록에도 안남·월남, 곧 베트남이 침향의 주요 산지이자 교역 상대로 자주 등장합니다.</p>
<p>중국 역사서와 무역 기록에도 임읍·교지·교주·점성 같은 지명이 침향의 주요 산지로 되풀이해 등장합니다.</p>
<p>다시 말해 부르는 지명은 시대마다 달라졌어도, 좋은 침향이 나는 땅에 대한 인식은 오래도록 한자리에 머물렀습니다.</p>
<p>대라천은 이 산지 이야기를 근거 없이 되풀이하지 않고, 어느 문헌에 어떤 지명으로 적혀 있는지를 함께 밝힙니다.</p>
...
<p>검사서를 볼 때는 세 가지를 먼저 찾으시기 바랍니다. 검사한 기관, 검사한 날짜, 그리고 검사번호입니다.</p>
<p>이 셋이 갖춰져야 나중에 같은 문서를 다시 대조할 수 있습니다. 문구만 있고 번호가 없는 안내는 되짚을 수 없는 주장에 가깝습니다.</p>
...
<p>향은 열과 빛을 만나면 먼저 날아갑니다. 창가나 차 안처럼 온도가 크게 오르내리는 자리는 피하시는 편이 좋습니다.</p>
...
<p>포장에 적힌 보관 표기가 가장 정확한 기준입니다. 제품마다 형태가 다른 만큼 라벨을 먼저 읽어 보시기 바랍니다.</p>
...
<p>약 200헥타르는 약 60만 평, 약 400만 그루는 한 농장에서 세기 어려운 숫자입니다. 5개 지역으로 나뉘어 있는 것도 그래서입니다.</p>
<p>규모 자체가 품질을 보증하지는 않습니다. 다만 원목을 사 오는 대신 직접 기르면, 어느 나무에서 나온 원료인지를 서류로 되짚을 수 있습니다.</p>
<p>대라천이 개별 나무에 번호를 붙이는 이유가 여기에 있습니다. 번호가 있으면 채취한 나무까지 거슬러 올라갈 수 있고, 번호가 없으면 그 경로는 끊깁니다.</p>
<p>기초⑥에서 본 검사 결과도 이 관리 체계 위에 얹힙니다. 검사서 한 장은 그 뒤에 서 있는 기록이 있을 때 힘을 갖습니다.</p>
<p>초보자가 이 대목을 다 외울 이유는 없습니다. 다만 판매자가 나무 관리 방식을 설명할 수 있는지 정도는 물어볼 만합니다.</p>
...
<p>『삼국사기』 권33 잡지 거기(車騎)조는 진골이라도 수레의 재목(車材)에 자단과 침향을 쓰지 못한다고 규정했습니다(<a href="https://db.history.go.kr/ancient/level.do?levelId=sg_033r_0030_0010" target="_blank" rel="noopener">한국사데이터베이스</a>).</p>
<p>같은 책 옥사(屋舍)조는 진골부터 6두품까지 침대를 대모와 침향으로 꾸미지 못한다고 적었습니다(<a href="https://db.history.go.kr/ancient/level.do?levelId=sg_033r_0050_0010" target="_blank" rel="noopener">한국사데이터베이스</a>). 신분이 높은 사람에게조차 금지 목록에 오를 만큼 귀한 재료였다는 뜻입니다.</p>
...
<p>이 글에 적은 농장 규모와 관리 방식은 대라천이 공개한 내용을 옮긴 것입니다. 대라천은 자체 자료의 범위 안에서만 이를 설명합니다.</p>
<p>확인되지 않은 대목은 채우지 않고 비워 두었습니다. 성경 속 향의 식별처럼 해석이 갈리는 자리에는 이견이 있다는 사실까지 함께 적었습니다.</p>
<p>대라천 침향 제품은 일반식품(또는 건강식품)입니다. 이 글의 어느 문장도 질병의 예방이나 치료를 뜻하지 않습니다.</p>
<p>복용량이나 섭취 방법을 권하는 문장도 두지 않았습니다. 제품별 표기와 라벨이 그 자리를 대신합니다.</p>
<h2>자주 묻는 질문</h2>
<h3>Q. 침향은 어떻게 쓰나요?</h3>
...
ART = {
    ...
    "changelog": {
        ...
        "citationsAdded": ["A1", "A7", "K1", "K4", "K5", "K6"],
        "voiceFixes": 21,
