...
<p>순서를 뒤집으면 고르기가 어려워집니다. 성분표부터 들여다보면 비교할 항목이 끝없이 늘어나지만, 생활 방식을 먼저 정하면 후보가 한둘로 줄어들고 그때부터 원료와 이력만 확인하면 됩니다. 첫 제품에서 실패를 줄이는 가장 단순한 방법입니다.</p>
...
<p>세 질문 가운데 어느 하나에서도 선뜻 예가 나오지 않는다면, 그 자체가 답이 되기도 합니다. 매일 챙기는 습관도 없고 음료나 명상도 아니라면 남는 것은 공간의 향이고, 이때는 부담이 가장 적은 선향부터 시작하시면 됩니다. 대라천이 진단표를 세 질문으로 짧게 끊어 둔 이유입니다.</p>
<p>반대로 두 곳 이상에서 예가 나오셨다면 순서를 정하시면 됩니다. 진단표는 하나만 고르라는 강요가 아니라 무엇을 먼저 시작할지 정해 주는 도구이므로, 첫 제품이 자리 잡은 뒤 두 번째 도착점으로 넘어가셔도 됩니다.</p>
...
<p>구성 수량을 먼저 확인하시면 총액이 다르게 읽힙니다. 대라천은 제품 표기에 구성 수량과 규격을 모두 적어 두었으므로, 값을 견주기 전에 이 숫자부터 나란히 놓아 보시기 바랍니다.</p>
...
<p>고르기 어려우시면 하루 일과를 떠올려 보시기 바랍니다. 아침에 영양제를 챙기는 자리가 이미 있다면 캡슐이 그 자리에 얹히고, 오후에 커피나 차를 마시는 시간이 있다면 파라미냐차가 그 자리를 대신합니다. 이미 있는 습관에 붙이는 쪽이 새 습관을 만드는 쪽보다 오래갑니다.</p>
...
<p>다만 두 제품은 불이나 온열판을 다루는 과정이 따릅니다. 선향은 사른 뒤 자리를 비우지 않도록, 스틱은 온열판 온도를 확인하도록 대라천은 안내하고 있습니다. 어린이나 반려동물이 있는 공간이라면 이 점을 먼저 고려하시기 바랍니다.</p>
<p>두 제품 사이에서 고민되신다면 쓰임의 폭으로 갈라 보시기 바랍니다. 선향은 향 하나에 집중한 제품이라 손이 덜 가고, 스틱은 향과 차를 오가며 쓸 수 있어 활용이 넓습니다. 향만 원하시면 선향, 여러 방식으로 써 보고 싶으시면 스틱입니다.</p>
...
<p>선물이 아니라 직접 쓰실 제품이라면 기본 구성이 기준선입니다. 큰 용량을 먼저 사면 취향이 맞지 않을 때 남는 양이 부담이 되고, 반대로 기본 구성은 한 바퀴 즐겨 본 뒤 이어 가기가 쉽습니다.</p>
<p>대라천은 제품별 구성과 가격을 <a href="/products">제품 페이지</a>에 함께 공개하고 있습니다. 예산을 정하실 때는 총액과 구성 수량을 나란히 놓고, 하루 또는 한 잔 단위로 환산해 비교해 보시기 바랍니다.</p>
...
<p>이 두 가지만 확인하셔도 첫 구매의 불확실성은 크게 줄어듭니다. 완벽한 선택을 하려고 애쓰기보다 확인 가능한 사실을 짚고 작게 시작하는 편이, 첫 침향을 오래 즐기는 길입니다.</p>
...
<p>선물할 때 왜 이 제품을 골랐는지 한 줄 곁들이시면 전달이 달라집니다. 25년산 원료라는 점이나 학명 이야기처럼 확인 가능한 사실이면 충분하고, 즐기는 방법과 보관법을 짧게 적어 넣으시면 더 좋습니다.</p>
<p>선물 상황별 구성과 가격을 더 살펴보시려면 <a href="/blog/agarwood-gift-guide">침향 선물 가이드</a>를 참고하시기 바랍니다.</p>
<p>받는 분의 생활을 모르실 때는 형태를 고르는 기준을 그대로 옮겨 보시면 됩니다. 매일 챙기시는 분께는 캡슐, 차를 즐기시는 분께는 파라미냐차, 조용한 시간을 아끼시는 분께는 묵주·팔찌가 자연스럽습니다.</p>
<p>선물에서 한 가지 더 살필 것은 주의사항입니다. 침향단·선향처럼 12세 미만 어린이와 임산부·수유부에게 권하지 않는 제품이 있으므로, 받는 분의 상황을 모르실 때는 이 제한이 없는 구성을 고르시는 편이 안전합니다.</p>
...
<p>제품 표기에 적힌 사용법도 대라천이 새로 권하는 양이 아니라 제품에 인쇄된 문구를 그대로 옮긴 것입니다. 규격 표기를 읽는 방법은 <a href="/blog/agarwood-oil-daily-dose-2-3mg">침향 오일 mg 표기 읽는 법</a>에 따로 정리해 두었습니다.</p>
...
out = {
    ...
    "excerpt": "캡슐, 차, 선향, 묵주 가운데 무엇부터 시작할지 막막하셨다면 예와 아니오만 따라가 보시기 바랍니다. 조엘라이프(주)가 안내하는 네 가지 생활 방식 기준으로 첫 침향 제품을 고르는 진단표와 구성 수량 비교표를 담았습니다.",
