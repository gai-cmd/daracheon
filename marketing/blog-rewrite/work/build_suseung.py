...
<p>네 글자를 읽는 순서도 뜻을 정합니다. 물이 먼저 오르고 불이 뒤이어 내린다는 배열은, 두 방향이 따로 일어나는 것이 아니라 한 짝으로 맞물린다는 옛 문헌의 서술 방식을 보여 줍니다. 낱말 하나가 아니라 짝으로 읽어야 하는 표현입니다.</p>
...
<p>기호로 적었다는 점이 중요합니다. 기호는 측정값이 아니어서 수치로 확인할 수 없고, 같은 기호라도 문헌마다 조금씩 다른 상태를 가리킬 수 있습니다. 옛 문헌을 읽을 때 표현의 폭을 넉넉히 잡아야 하는 이유입니다.</p>
''' + SVG + '''
...
<p>인용의 범위도 밝혀 둡니다. 한국민족문화대백과사전 항목으로 확인할 수 있는 것은 향약집성방이라는 책의 편찬 내력과 성격까지이며, 침향 항목의 세부 표현은 대라천이 정리한 문헌 자료를 근거로 옮긴 것입니다. 두 근거는 성격이 다르므로 이 글에서도 나누어 적었습니다.</p>
...
<p>표의 세 줄을 견주면 강조점의 차이도 보입니다. 향약집성방과 본초강목은 수승화강을 직접 언급했고, 동의보감은 같은 낱말 대신 기(氣)와 온중(溫中)의 어휘로 침향을 적었습니다. 겹치는 부분과 갈리는 부분을 함께 두는 편이 기록을 있는 그대로 보여 줍니다.</p>
...
<p>대라천이 이 용어들을 풀어 두는 이유도 여기에 있습니다. 뜻을 밝히지 않은 채 한자어만 옮기면, 읽는 쪽에서 각자의 방식으로 오늘의 개념을 대입하게 됩니다. 한자어를 그대로 두는 것이 원문에 충실한 듯 보여도, 풀이가 빠지면 오히려 없던 뜻이 붙습니다. 성미(性味) 같은 다른 분류 언어를 읽는 방법은 <a href="/blog/agarwood-nature-and-taste-seongmi">침향의 성미 읽는 법</a>에 따로 정리했습니다.</p>
...
<p>구분의 기준은 단순합니다. 문헌 기록은 옛 책이 무엇을 적었는지에 관한 자료이고, 학술 논문은 성분이 무엇인지에 관한 자료이며, 제품에 관한 자료는 검사 성적서와 규격 문서입니다. 세 가지는 답하는 질문이 각각 달라서 서로를 대신하지 못합니다.</p>
...
<p>수천 년을 건너온 표현을 오늘의 낱말로 서둘러 옮기지 않는 편이 좋습니다. 옮기는 순간 기록은 주장이 되고, 주장이 되는 순간 근거를 요구받습니다. 옛 문헌이 감당할 수 있는 몫은 거기까지가 아닙니다.</p>
...
<p>이 글에서 문헌을 다루는 대목과 제품을 언급하는 대목을 나누어 배치한 이유도 같습니다. 확인할 수 있는 것과 확인할 수 없는 것을 한 문단 안에 섞으면, 읽는 쪽에서는 둘을 가려낼 방법이 없습니다.</p>
...
out = {
    ...
    "excerpt": "향약집성방과 본초강목은 침향 항목에 수승화강(水昇火降)을 함께 적었습니다. 조엘라이프(주)가 세 문헌의 기록을 원문 표기 그대로 옮기고, 담음·이기 같은 전통 용어를 풀며, 이 개념이 제품의 작용 주장과 어떻게 다른지 선을 긋습니다.",
