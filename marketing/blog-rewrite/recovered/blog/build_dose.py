...
<figure>%(SVG_SRC)s<figcaption style='font-size:13px;color:#7D7570'>같은 침향이라도 분말과 오일은 규격에 쓰는 단위가 1,000배 넘게 차이 납니다. 섭취량 안내가 아니라 표기 단위 비교입니다. (출처: 대라천 제품 자료)</figcaption></figure>
...
<p>침향수는 25년산 침향을 증류해 얻은 추출물 100% 제품입니다. 표기 기준은 하루 20ml이며, 가습기나 분무기에 담아 공간에 뿌리는 쓰임도 함께 안내합니다.</p>
...
<figure>%(SVG_RATIO)s<figcaption style='font-size:13px;color:#7D7570'>참침향 오일 캡슐 표기 기준 — 침향수지오일 0.59%%가 캡슐 내용물에서 차지하는 비율. 나머지는 적송오일·오메가3·비타민E 등 부원료입니다. (출처: 대라천 제품 표기)</figcaption></figure>
...
""" % {'SVG_SRC': SVG_SRC, 'SVG_RATIO': SVG_RATIO, 'TABLE': TABLE}
...
out = {
    ...
    "excerpt": "대라천 자료의 2~3mg은 권장 섭취량이 아니라 침향 오일의 규격 단위입니다. 조엘라이프(주)가 오일 캡슐 0.59%, 3mL, 30캡슐 같은 제품 규격을 어떻게 표기했는지 표로 정리했습니다.",
