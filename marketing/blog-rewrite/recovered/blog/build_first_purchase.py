...
CONTENT = '''<p class="lead"><strong>결론부터.</strong> 첫 침향 구매의 불안은 취향의 문제가 아니라 정보의 문제입니다. 조엘라이프(주)(브랜드 대라천)는 원목의 품종을 DowGene 유전자 검사로 확인했고(검사번호 DA-260507-1), CITES 부속서 등재(IIA-DNI-007)와 중금속 8종 시험 결과, 나무 한 그루 단위의 재배 기록을 문서로 보유하고 있습니다. 판매자의 설명을 믿을지 고민하는 대신, 이 문서들을 요청해 확인하시면 됩니다. 대라천 침향 제품은 일반식품입니다.</p>
...
<p>기울기를 줄이는 방법은 하나뿐입니다. 판매자의 표현을 해석하는 대신, 문서로 남은 항목을 직접 확인하는 것입니다. 아래에서는 대라천이 무엇을 문서로 남겨 두었는지, 그중 무엇을 요청해 볼 수 있는지를 차례로 적습니다.</p>
...
<p>주의 대상도 표기로 확인합니다. 대라천 안내에 따르면 침향단·침향선향 같은 일부 제품은 12세 미만 어린이와 임산부·수유부에게 권장되지 않으며, 침향 성분에 과민증이 있는 분께도 권하지 않습니다.</p>
<p>주의사항이 상세히 적혀 있는지도 판단 재료가 됩니다. 대상과 조건을 좁혀 적어 둔 표기는 제품이 누구를 위한 것인지 판매자가 스스로 밝힌 기록입니다. 제품별 주의사항은 구매 전에 항목마다 확인하시는 편이 좋습니다.</p>
...
<p>다만 한 가지가 더해집니다. 받는 분이 부담 없이 쓸 수 있는 형태인지를 함께 보는 일입니다. 매일 챙기기 좋은 오일 캡슐, 향과 형태를 함께 담은 침향 묵주·합장주가 선물 목적으로 자주 선택됩니다.</p>
...
<p>대라천은 선물용 제품에도 같은 서류를 적용합니다. 요청하시면 해당 제품의 시험성적서와 인증서를 동일하게 확인해 드립니다. 나무 단위 기록이 어떻게 관리되는지는 <a href="/blog/individual-tree-id-traceability">침향 이력관리</a>에 적었습니다.</p>
...
<p>확인하지 않은 것도 함께 밝힙니다. 대라천은 다른 판매처의 원료나 서류를 검증한 바 없으며, 이 글의 확인 항목은 대라천이 자사 원료에 적용하는 기준입니다. 본문에 인용한 학술 논문은 해당 연구팀의 결과이고 제품의 효능을 뒷받침하는 자료가 아닙니다. 대라천 침향 제품은 일반식품이며 질병의 예방이나 치료를 목적으로 하지 않고, 반응에는 개인차가 있습니다. 가짜 원료가 유통되는 구조는 <a href="/blog/why-fake-agarwood-market-exists">가짜 침향 시장이 생기는 이유</a>에 따로 정리했습니다.</p>
...
out = {
    ...
    "excerpt": "첫 침향 구매의 불안은 정보의 문제입니다. 조엘라이프(주)는 품종·산지·합법성·안전성·이력 다섯 항목을 검사번호와 함께 문서로 보유합니다. 무엇을 요청해 확인할 수 있는지 순서대로 정리했습니다.",
