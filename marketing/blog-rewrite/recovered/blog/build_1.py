...
A('<p>품종과 산지는 값을 정당화하는 근거가 아니라 값을 비교할 수 있게 만드는 기준선입니다. 학명이 다른 원료끼리, 산지가 다른 원료끼리 값만 견주는 비교는 성립하지 않습니다.</p>')
...
out = {
    ...
    "excerpt": "조엘라이프(주)가 정리한 침향이 비싼 이유입니다. 수확까지 최소 26년, 원목 400kg에서 오일 20~25cc라는 수율, CITES 절차와 검사 비용이 값에 쌓이는 과정을 수치와 함께 짚었습니다.",
